Crearemos un app de notas.
    ...
    6. Express sera una dependencia (npm i express).
        En este momento ya tenemos mas archivos en nuestra carpeta, los cuales son el paquete (json), los (node_modules) y el (package-lock)
    ...
    11. En el archivo index, llamamos a nuestro paquete express y lo llamamos en el puerto de nuestra preferencia, siempre verificar que dicho puerto este vacio.